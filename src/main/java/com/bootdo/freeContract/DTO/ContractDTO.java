package com.bootdo.freeContract.DTO;
...
public class ContractDTO implements Serializable {
	...
	public String toString() {
		return "ContractDTO [contractId=" + contractId + ", contractName=" + contractName + ", contractType="
				...
				+ myself + ", mainpaper=" + mainpaper + ", modelId=" + modelId + ", secondarypaper=" + secondarypaper
				+ ", otherpaper=" + otherpaper + ", needCost=" + needCost + ", actualCost=" + actualCost + ", needBill="
				+ needBill + ", actualBill=" + actualBill + ", moneyProgress=" + moneyProgress + ", billProgress="
				+ billProgress + ", charger=" + charger + ", office=" + office + ", state=" + state + ", creatiedUser="
				+ creatiedUser + ", creatiedTime=" + creatiedTime + ", modifiedUser=" + modifiedUser + ", modifiedTime="
				+ modifiedTime + ", needShengpi=" + needShengpi + ", contractKind=" + contractKind + ", documentPlace="
				+ documentPlace + ", isDelete=" + isDelete + "]";
	}
