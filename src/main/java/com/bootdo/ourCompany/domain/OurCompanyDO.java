package com.bootdo.ourCompany.domain;
 ...
 */
public class OurCompanyDO implements Serializable {
	...
	public String toString() {
		return "OurCompanyDO [ourcompanyid=" + ourcompanyid + ", name=" + name + ", type=" + type + ", state=" + state
